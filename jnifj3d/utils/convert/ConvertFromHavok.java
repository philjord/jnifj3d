...
public class ConvertFromHavok
{
	...
	{
		return createScaledVector(transform.m14, transform.m24, transform.m34);
	}
	...
	{
		return new Point3f(x * ESConfig.HAVOK_TO_METERS_SCALE, //
				z * ESConfig.HAVOK_TO_METERS_SCALE, //
				-y * ESConfig.HAVOK_TO_METERS_SCALE);
	}

	private static Vector3f createScaledVector(float x, float y, float z)
	{
		return new Vector3f(x * ESConfig.HAVOK_TO_METERS_SCALE, //
				z * ESConfig.HAVOK_TO_METERS_SCALE, //
				-y * ESConfig.HAVOK_TO_METERS_SCALE);
	}
	...
	public static Point3f toJ3dP3fNif(NifVector3 v)
	{
		return new Point3f(v.x * ESConfig.ES_TO_METERS_SCALE, //
				v.z * ESConfig.ES_TO_METERS_SCALE, //
				-v.y * ESConfig.ES_TO_METERS_SCALE);
	}
	
	// NOTE:!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!! this uses the nif scale NOT the havok one!!!!
	public static Point3f toJ3dP3fNif(NifVector4 v)
	{
		return new Point3f(v.x * ESConfig.ES_TO_METERS_SCALE, //
				v.z * ESConfig.ES_TO_METERS_SCALE, //
				-v.y * ESConfig.ES_TO_METERS_SCALE);
	...
	public static Vector3f toJ3dExtents(NifVector3 dimensions)
	{
		return new Vector3f(dimensions.x * ESConfig.HAVOK_TO_METERS_SCALE, //
				dimensions.z * ESConfig.HAVOK_TO_METERS_SCALE, //
				dimensions.y * ESConfig.HAVOK_TO_METERS_SCALE);
	}
